...
log_loc = "G:/noise-removal-kernels-"+type+"/autoencoder/"+str(dataset_num)+"/"
...
val_file = log_loc+"val_log.txt"+'don\'t use'
...
if save:
    save_loc = (log_loc+"log.npy")
    np.save(save_loc, losses)

if save_val:
    save_loc = (log_loc+"val_log.npy")
