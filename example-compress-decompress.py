...
#ATM compression only works for sides that are multiples of 160. 1120 = 7*160
#Try replacing this with your own image!
img = np.random.rand(1120, 1120)
...
print("Image is {} times its original size".format(compressed_img.size/img.size))
...
print("Image 2 is {} times its original size".format(compressed_img.size/img.size))
